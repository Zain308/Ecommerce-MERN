...
const Cart = ({ setOpenCart }) => {
  // This will eventually come from Redux, but for now, we keep your dummy data
  const cartData = [
    { name: "Iphone 14 pro max 256 gb ssd", price: 999 },
    { name: "Iphone 14 pro max silver", price: 245 },
    { name: "Iphone 14 pro max 8gb ram", price: 645 },
  ];

  // FIX: Calculate dynamic total price for the button
      ...
      <div className="w-full flex items-center justify-between">
        <div className="flex items-center">
          <div className="flex flex-col items-center">
            ...
            <span className="py-[5px]">{value}</span>
            <div
        ...
        <RxCross1 size={20} className="cursor-pointer text-[#00000082]" />
      </div>
    </div>
  );
};
