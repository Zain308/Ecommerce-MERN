                ...
                {searchData && searchData.length !== 0 && (
                  <div className="absolute bg-[#fff] z-10 shadow w-full left-0 p-3">
                    {searchData.map((i, index) => {
                      const Product_name = i.name.replace(/\s+/g, "-");
                      return (
                        <Link to={`/product/${Product_name}`} key={index} onClick={() => setOpen(false)}>
              ...
              <div className="flex w-full justify-center pb-8">
                {isAuthenticated ? (
                  ...
                  <div className="flex items-center gap-2">
                    <Link to="/login" className="text-[18px] text-[#000000b7] font-[500]">Login /</Link>
                    <Link to="/sign-up" className="text-[18px] text-[#000000b7] font-[500]">Sign up</Link>
                  </div>
                )}
              </div>
            </div>
